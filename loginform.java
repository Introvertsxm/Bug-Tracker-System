...
public class loginform extends JFrame {
	...
	public loginform() {
		...
		lblNewLabel.setBounds(84, 137, 132, 28);
		...
		JLabel lblNewLabel_2 = new JLabel("BUG TRACKER SYSTEM");
		lblNewLabel_2.setBounds(131, 30, 413, 51);
		lblNewLabel_2.setFont(new Font("GEORGIA", Font.BOLD, 27));
		panel_1.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("LOGIN FORM");
		lblNewLabel_3.setFont(new Font("GEORGIA", Font.BOLD, 17));
		lblNewLabel_3.setBounds(200, 95, 169, 21);
