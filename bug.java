...
public class bug extends JFrame {
	...
	public bug() {
		...
		comboBox.setModel(
				new DefaultComboBoxModel(new String[] { "select", "javaedit", "roundfx", "productsolution" }));
		panel_3.add(comboBox);

		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBounds(10, 96, 292, 26);
		comboBox_1.setFont(new Font("GEORGIA", Font.PLAIN, 14));
		comboBox_1.setModel(new DefaultComboBoxModel(
				new String[] { "select", "Windows 7", "Windows 8", "Windows 10", "Windows 11", "Linux" }));
		panel_3.add(comboBox_1);

		JComboBox comboBox_2 = new JComboBox();
		comboBox_2.setBounds(10, 132, 292, 26);
		comboBox_2.setFont(new Font("GEORGIA", Font.PLAIN, 14));
		...
		comboBox_3.setFont(new Font("GEORGIA", Font.PLAIN, 14));
		...
		btnNewButton_1.setBounds(234, 408, 240, 26);
		...
		lblNewLabel_3.setBounds(40, 129, 194, 24);
